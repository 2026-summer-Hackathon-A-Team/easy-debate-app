...
CREATE TABLE `user` (
    ...
    UNIQUE INDEX `user_user_name_delete_marker_key`(`user_name`, `delete_marker`),
    PRIMARY KEY (`id`)
...
-- AddForeignKey
ALTER TABLE `battle_history` ADD CONSTRAINT `battle_history_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `user`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `rate_updown_history` ADD CONSTRAINT `rate_updown_history_battle_history_id_user_id_fkey` FOREIGN KEY (`battle_history_id`, `user_id`) REFERENCES `battle_history`(`id`, `user_id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `moral_updown_history` ADD CONSTRAINT `moral_updown_history_battle_history_id_user_id_fkey` FOREIGN KEY (`battle_history_id`, `user_id`) REFERENCES `battle_history`(`id`, `user_id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `moral_violation_history` ADD CONSTRAINT `moral_violation_history_battle_history_id_user_id_fkey` FOREIGN KEY (`battle_history_id`, `user_id`) REFERENCES `battle_history`(`id`, `user_id`) ON DELETE RESTRICT ON UPDATE CASCADE;
