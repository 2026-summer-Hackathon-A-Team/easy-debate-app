        ...
        <div className="flex flex-col gap-3.5 w-full md:w-72 md:flex-shrink-0">
          ...
          <div className="bg-white border border-[#e4e2dd] rounded-2xl p-4.5 flex flex-col gap-2.5">
            ...
            >
              ...
              {isMyTurn && (
                <span className="text-xs font-extrabold text-[#2c4d3b] bg-[#cfe1d6] rounded-full px-2 py-0.5 whitespace-nowrap">
                  あなた
                </span>
              )}
            </div>
            ...
            >
              ...
              {!isMyTurn && (
                <span className="text-xs font-extrabold text-[#8a5a2e] bg-[#ecd8bf] rounded-full px-2 py-0.5 whitespace-nowrap">
                  相手
                </span>
              )}
            </div>
